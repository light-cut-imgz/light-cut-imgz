#!/usr/bin/env bash
# light-cut-imgz — one-line uninstaller for macOS and Linux.
#
#   curl -fsSL https://raw.githubusercontent.com/light-cut-imgz/light-cut-imgz/main/uninstall.sh | bash
#
...
REPO="light-cut-imgz/light-cut-imgz"
TAP="light-cut-imgz/tap"
CASK="light-cut-imgz"
APP_NAME="light-cut-imgz"
APP_SLUG="light-cut-imgz"
DEB_PACKAGE="light-cut-imgz"
ICON_SIZE="256x256"
